...
{
    public class EnvironmentalRiskModelTests : TestBase
    {
        protected HomePage _homePage;
        private const string _partialUrl = "Pages/AlternativeValue/Views/AlternativeValue.aspx?id=6083&altid=4927&tabId=";
        ...
        [Test]
        public void EnvironmentalRiskMeasure_CheckBaselineResult()
        {
            ...
            //select Environmental Risk value model
            questionnairesTab.SelectValueModel(ValueModels.EnvironmentalRisk);
