...
namespace DukeTransmission.UITests.Tests
{
    public class ComplianceRiskModelTests : TestBase
    {
        ...
        private const string _partialUrl = "Pages/AlternativeValue/Views/AlternativeValue.aspx?id=6082&altid=4926&tabId=";
        ...
        public void ComplianceRiskMeasure_CheckBaselineResult()
        {
            ...
            //select Compliance Risk value model
            questionnairesTab.SelectValueModel(ValueModels.ComplianceRisk);
            var valueDetailsTab = questionnairesTab.SelectValueDetailsTab();

            // open Breakdown dialog for Compliance Risk value measure
            valueDetailsTab.SelectValueMeasure(ValueMeasures.ComplianceRisk);
            ...
            var actual = decimal.Parse(inspectBreakdownDialog.ComplianceRiskBaselineResult);
