...
namespace DukeTransmission.UITests.ExtensionMethods
{
    public static class DriverExtensionMethods
    {
        ...
        /// </summary>
        public static IWebElement FindElementWait(this RemoteWebDriver driver, By by, int timeout = 30)
        {
        ...
        /// </summary>
        public static IEnumerable<IWebElement> FindElementsWait(this RemoteWebDriver driver, By by, int timeoutSeconds = 20)
        {
        ...
        /// </summary>
        public static void WaitUntilElementIsClickable(this RemoteWebDriver driver, IWebElement element, int timeout = 15)
        {
            var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeout));
        ...
        /// </summary>
        public static bool IsElementVisible(this RemoteWebDriver driver, By by, int timeout = 60)
        {
